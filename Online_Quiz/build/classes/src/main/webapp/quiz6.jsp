...
%>
    ...
    <form class="quiz-box" action="quiz7.jsp" method="post" onsubmit="return checkAnswer()">
        <div id="timer" style="color:red;font-weight:bold"></div>

        <h2>6) When was Pravasi Bhartiya Divas held in Varanasi?</h2>

        <label class="option">
            <input type="radio" name="q6" value="2017" required>
            A) 2017
        </label>

        <label class="option">
            <input type="radio" name="q6" value="2015">
            B) 2015
        </label>

        <label class="option">
            <input type="radio" name="q6" value="2019">
            C) 2019
        </label>

        <label class="option">
            <input type="radio" name="q6" value="2020">
            D) 2020
        </label>
