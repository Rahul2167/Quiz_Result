...
<head>
    ...
    function checkAnswer() {
        ...
        let correctAnswer = "Alexander Graham Bell";
...
%>
    ...
    <form class="quiz-box" action="quiz5.jsp" method="post" onsubmit="return checkAnswer()">
    <div id="timer" style="color:red;font-weight:bold"></div>

        <h2>4) Who invented the telephone?</h2>

        <label class="option">
            <input type="radio" name="q4" value="Thomas Edison" required>
            A) Thomas Edison
        </label>

        <label class="option">
            <input type="radio" name="q4" value="Alexander Graham Bell">
            B) Alexander Graham Bell
        </label>

        <label class="option">
            <input type="radio" name="q4" value="Nikola Tesla">
            C) Nikola Tesla
        </label>

        <label class="option">
            <input type="radio" name="q4" value="James Watt">
            D) James Watt
        </label>
