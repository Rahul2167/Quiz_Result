...
%>
    ...
    <form class="quiz-box" action="quiz8.jsp" method="post" onsubmit="return checkAnswer()">
        <div id="timer" style="color:red;font-weight:bold"></div>

        <h2>7) Vijay Singh (golf player) is from which country?</h2>

        <label class="option">
            <input type="radio" name="q7" value="UK" required>
            A) UK
        </label>

        <label class="option">
            <input type="radio" name="q7" value="USA">
            B) USA
        </label>

        <label class="option">
            <input type="radio" name="q7" value="India">
            C) India
        </label>

        <label class="option">
            <input type="radio" name="q7" value="Fiji">
            D) Fiji
        </label>
