<%@ page import="java.sql.*" %>
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        <%! public String parsePsql(String psql) { if (psql==null) return null; String t=psql.trim(); if
            ...
            <body>
                <% String q10Param=request.getParameter("q10"); if (q10Param !=null) session.setAttribute("q10",
                    q10Param); String sName=request.getParameter("fullname"); if (sName !=null &&
                    !sName.trim().isEmpty()) { session.setAttribute("f1", sName); } String name=(String)
                    session.getAttribute("f1"); if (name==null) name="Guest" ; String q1=(String)
                    ...
                    ("2019".equals(q6)) score++; if ("Fiji".equals(q7)) score++; if ("Department of Research and
                    Development Laboratory".equals(q8)) score++; if ("Uranus".equals(q9)) score++; if ("Dr A.P.J. Abdul
                    Kalam".equals(q10)) score++; String resV=(score>= 6) ? "PASS" : "FAIL";
                    ...
                    java.util.List<String[]> strategies = new java.util.ArrayList<String[]>();
                            ...
                            if (pURL != null) {
                            strategies.add(new String[]{ pURL + (pURL.contains("?") ? "" : "?sslmode=require"),
                            "URL_SSL" });
                            ...
                            ps.executeUpdate();
                            con.close();
                            } else { errorMsg = "Database connection failed."; }
                            ...
                            <div class="box">
                                ...
                                <% if (errorMsg !=null) { %>
                                    <div
                                        ...
                                        <%= errorMsg %> <br>
                                            <small>Result was not saved.</small>
                                    </div>
                                    <% } %>
                                        <h3>Candidate: <%= name %>
                                        </h3>
                                        ...
                                        <p>Q2: Mahatma Gandhi | <%= q2 %>
                                        </p>
                                        <p>Q3: Jupiter | <%= q3 %>
                                        </p>
                                        <p>Q4: Alexander Graham Bell | <%= q4 %>
                                        </p>
                                        <p>Q5: Nile | <%= q5 %>
                                        </p>
                                        <p>Q6: 2019 | <%= q6 %>
                                        ...
                                        <p>Q10: Dr A.P.J. Abdul Kalam | <%= q10 %>
                                        </p>
