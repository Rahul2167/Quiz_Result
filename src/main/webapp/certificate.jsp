...
<body>
    <%
        // Retrieve candidate name from session, default to "Guest Candidate"
        ...
        String ans8 = "Department of Research and Development Laboratory";
        if (ans8.equals(q8)) score++;
    ...
    <div id="certificate">
        ...
        <table>
            <tr><th>#</th><th>Question Keyword</th><th>Correct Answer</th><th>Your Answer</th></tr>
            <tr><td>1</td><td>Capital of India</td><td>New Delhi</td><td><%= q1 != null ? q1 : "-" %></td></tr>
            <tr><td>2</td><td>Father of Nation</td><td>Mahatma Gandhi</td><td><%= q2 != null ? q2 : "-" %></td></tr>
            <tr><td>3</td><td>Largest Planet</td><td>Jupiter</td><td><%= q3 != null ? q3 : "-" %></td></tr>
            <tr><td>4</td><td>Telephone Inventor</td><td>Alexander Graham Bell</td><td><%= q4 != null ? q4 : "-" %></td></tr>
            <tr><td>5</td><td>Longest River</td><td>Nile</td><td><%= q5 != null ? q5 : "-" %></td></tr>
            <tr><td>6</td><td>Covid Start Year</td><td>2019</td><td><%= q6 != null ? q6 : "-" %></td></tr>
            <tr><td>7</td><td>Country</td><td>Fiji</td><td><%= q7 != null ? q7 : "-" %></td></tr>
            <tr><td>8</td><td>DRDL Full Form</td><td>Dept. of Research...</td><td><%= q8 != null ? q8 : "-" %></td></tr>
            <tr><td>9</td><td>Planet</td><td>Uranus</td><td><%= q9 != null ? q9 : "-" %></td></tr>
            <tr><td>10</td><td>Missile Man</td><td>Dr A.P.J. Abdul Kalam</td><td><%= q10 != null ? q10 : "-" %></td></tr>
        </table>
